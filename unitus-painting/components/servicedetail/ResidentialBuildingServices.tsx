    ...
    <div className="bg-white mt-24">
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8">
          ...
          <section className="order-1 lg:order-2 lg:col-span-2">
            <FeaturedProject 
              ...
              description={ResidentalContent.descriptionText}
        ...
        <ProjectShowcase 
          ...
          title={ResidentalContent.projectShowcaseTitle} 
        />
      </main>
      
      <CallToAction 
        title={ResidentalContent.ctaTitle} 
        buttonText={ResidentalContent.ctaButtonText} 
      />
    </div>
  );
};
