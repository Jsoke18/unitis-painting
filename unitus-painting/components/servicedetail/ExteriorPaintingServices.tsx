...
const ExteriorPaintingService: React.FC = () => {
  const serviceData = {
    ...
    // Explicitly setting the video URL
    videoUrl: "https://storage.googleapis.com/unitis-videos/unitus_painting_-_exterior_painting_review%20(1080p).mp4",
    features: [
  ...
  // Log the video URL to verify it's being passed
  console.log('Video URL:', serviceData.videoUrl);
