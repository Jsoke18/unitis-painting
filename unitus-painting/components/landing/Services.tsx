...
const ServiceTab: React.FC<{
  ...
  const baseClasses =
    "flex gap-2.5 px-6 py-3 border border-solid cursor-pointer transition-all duration-300 ease-in-out";
    ...
    >
      <div className="flex flex-col items-center max-w-6xl w-full">
        ...
        >
          ...
          quality, safety, and efficiency. Our customers appreciate our focus on
          minimizing disruptions, meticulous attention to detail, and
          competitive pricing.
        </motion.p>
        <motion.div
          ...
          <div className="flex flex-col md:flex-row md:items-stretch gap-8 h-auto md:h-[400px]">
            <div className="flex flex-col justify-between md:w-1/2 h-full">
              ...
              <Link href={activeService.content.link} passHref legacyBehavior>
                <motion.a
                  className="px-8 py-3 mt-6 text-lg font-semibold bg-amber-400 text-blue-950 border-2 border-amber-400 rounded-md hover:bg-amber-500 transition-colors duration-300 w-full md:w-auto inline-block text-center"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Read More
