...
const ExpertiseCard: React.FC<ExpertiseCardProps> = ({ title, description, imageSrc, icon, link }) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-6">
        ...
        <Link href={link} passHref>
          <span className="text-[#1C2752] hover:text-[#FFB342] transition-colors duration-300 font-semibold flex items-center cursor-pointer">
            Learn More
